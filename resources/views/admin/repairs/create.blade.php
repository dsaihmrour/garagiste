        ...
        <div class="col-xl-6 mx-auto">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form class="row g-3" method="post" action="{{ route('repairs.store') }}">
                        @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="input-group">
                                <input name="mechanic_id" type="text" class="form-control" id="userFilter"
                                    placeholder="Filter Mechanic" list="userList" autocomplete="off">

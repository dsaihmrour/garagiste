                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input name="partName" type="text" class="form-control" id="input25"
                                    placeholder="Part Name" value="{{ $sparePart->partName ?? old('partName') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input name="partReference" type="text" class="form-control" id="input26"
                                    ...
                                    value="{{ $sparePart->partReference ?? old('partReference') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input name="supplier" type="text" class="form-control" id="input26"
                                    placeholder="Supplier" value="{{ $sparePart->supplier ?? old('supplier') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input name="price" type="text" class="form-control" id="input27" placeholder="Price"
                                    value="{{ $sparePart->price ?? old('price') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input name="stock" type="number" min="0" class="form-control" id="input28"
                                    placeholder="Stock" value="{{ $sparePart->stock ?? old('stock') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <label for="input29" class="form-label">Description</label>
                            <div class="input-group">
                                <textarea name="description" class="form-control" id="input29" rows="3" placeholder="Description">{{ $sparePart->description ?? old('description') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">

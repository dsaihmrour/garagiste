        ...
        <div class="card-body">
            <div id="invoice">
                <div class="toolbar hidden-print">
                    <div class="text-end">
                        <a href="/admin/pdfs/invoicePDF/{{ $data->id }}" class="btn btn-danger"><i
                        ...
                        <main>
                            <div class="row contacts">
                                <div class="col invoice-to">
                                    ...
                                    <h2 class="to">{{ $data->user->firstName }} {{ $data->user->lastName }}
                                    </h2>
                                    <div class="address">{{ $data->user->address }}</div>
                                    <div class="email"><a href="mailto:john@example.com">{{ $data->user->email }}</a>
                                    </div>
                                </div>
                            ...
                            <table>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->additionalCharges }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td colspan="2">GRAND TOTAL</td>
                                        <td>{{ $data->additionalCharges + $data->totalAmount }}</td>
                                    </tr>
                                </tfoot>
                            </table>

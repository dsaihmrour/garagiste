...
@section('content')
    @component('client.components.location', ['page' => 'Update Vehicle', 'subpage' => '', 'title' => 'Vehicles'])
        <div class="row">
            @if (count($errors) > 0)
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" method="post"
                            action="{{ route('client.vehicles.update', ['vehicle' => $vehicle]) }}" enctype="multipart/form-data">
                            <div class="col-md-12">
                                @method('PUT')
                                @csrf

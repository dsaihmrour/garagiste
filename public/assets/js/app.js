$(function () {
    ...
    $(".mobile-search-icon").on("click", function () {
        ...
        // on page load, get the theme mode from local storage and set the initial theme
    ...
    $(".dark-mode").on("click", function () {
        // get current theme mode from local storage
        ...
        // store the theme mode in the local storage

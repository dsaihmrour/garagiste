$(function () {
    ...
    $("#single-select-clear-field-mechanic").select2({
        theme: "bootstrap-5",
        width: $("#single-select-clear-field-mechanic").data("width")
            ? $("#single-select-clear-field-mechanic").data("width")
            : $("#single-select-clear-field-mechanic").hasClass("w-100")
            ? "100%"
            : "style",
        placeholder: $("#single-select-clear-field-mechanic").data(
            "placeholder"
        ),
        allowClear: true,
    });

    $("#single-select-clear-field-vehicle").select2({
        theme: "bootstrap-5",
        width: $("#single-select-clear-field-vehicle").data("width")
            ? $("#single-select-clear-field-vehicle").data("width")
            : $("#single-select-clear-field-vehicle").hasClass("w-100")
            ? "100%"
            : "style",
        placeholder: $("#single-select-clear-field-vehicle").data(
            "placeholder"
        ),
        allowClear: true,
    });

    $("#single-select-clear-field-invoice").select2({
        theme: "bootstrap-5",
        width: $("#single-select-clear-field-invoice").data("width")
            ? $("#single-select-clear-field-invoice").data("width")
            : $("#single-select-clear-field-invoice").hasClass("w-100")
            ? "100%"
            : "style",
        placeholder: $("#single-select-clear-field-invoice").data(
            "placeholder"
        ),
        allowClear: true,
    });
